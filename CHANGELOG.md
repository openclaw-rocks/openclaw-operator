...
## [0.10.0](https://github.com/openclaw-rocks/k8s-operator/compare/v0.9.12...v0.10.0) (2026-02-18)
...
* add workflow_dispatch trigger for manual OperatorHub submissions ([#51](https://github.com/openclaw-rocks/k8s-operator/issues/51)) ([f53bc58](https://github.com/openclaw-rocks/k8s-operator/commit/f53bc583f00c96603f4a437eeeabb393c15f5ca5))
...
* migrate workload from Deployment to StatefulSet ([145e6ba](https://github.com/openclaw-rocks/k8s-operator/commit/145e6babc08704ba376752208926558d801e05c4))
* migrate workload from Deployment to StatefulSet ([6e3d491](https://github.com/openclaw-rocks/k8s-operator/commit/6e3d49106f228920e2d0621695dbb7046e4bced6))
* native workspace file seeding via CRD spec ([#58](https://github.com/openclaw-rocks/k8s-operator/issues/58)) ([de06c4a](https://github.com/openclaw-rocks/k8s-operator/commit/de06c4a618ad912f79deffc5f2fd1cb102cb4a42))
* PVC backup-on-delete and restore-from-backup ([#60](https://github.com/openclaw-rocks/k8s-operator/issues/60)) ([d49fb1a](https://github.com/openclaw-rocks/k8s-operator/commit/d49fb1a5152dedc47ffede4092b6bd903546aca4))
...
* configure git credential helper for OperatorHub push ([#54](https://github.com/openclaw-rocks/k8s-operator/issues/54)) ([ef8bb8f](https://github.com/openclaw-rocks/k8s-operator/commit/ef8bb8fe3698fc885b8ad9348b3f2b1b4d32ffae))
* configure git identity for OperatorHub submission commits ([#53](https://github.com/openclaw-rocks/k8s-operator/issues/53)) ([8b58876](https://github.com/openclaw-rocks/k8s-operator/commit/8b58876feb946c22c931b15ace69e6b2bfa85859))
* create operator directory for first-time OperatorHub submission ([#52](https://github.com/openclaw-rocks/k8s-operator/issues/52)) ([58faaca](https://github.com/openclaw-rocks/k8s-operator/commit/58faaca8b54fdee094686c8ece440392a82f964e))
* create release tag when skip-github-release is enabled ([#49](https://github.com/openclaw-rocks/k8s-operator/issues/49)) ([95ffd24](https://github.com/openclaw-rocks/k8s-operator/commit/95ffd2408a3e085bd60f522b1671387b8f81be98))
...
* force push OperatorHub branch for retry resilience ([#56](https://github.com/openclaw-rocks/k8s-operator/issues/56)) ([a18836f](https://github.com/openclaw-rocks/k8s-operator/commit/a18836f567294bf90d45b05848b9851f7ba7697c))
...
* make OperatorHub workflow idempotent on re-runs ([#63](https://github.com/openclaw-rocks/k8s-operator/issues/63)) ([811e682](https://github.com/openclaw-rocks/k8s-operator/commit/811e682d0f03450ea04facef8e0d5de7a9eb745f))
...
* sync fork with upstream in OperatorHub workflow and fix Helm chart versioning ([#61](https://github.com/openclaw-rocks/k8s-operator/issues/61)) ([31c61bd](https://github.com/openclaw-rocks/k8s-operator/commit/31c61bd35a2be6e1c89c6e4d66c555bd2f5aa110))
...
* update OLM bundle CSV to v0.9.0 and fix spec.version replacement ([#62](https://github.com/openclaw-rocks/k8s-operator/issues/62)) ([d82821f](https://github.com/openclaw-rocks/k8s-operator/commit/d82821f22fb029d29d20b664abd02bad7b6c2cd9))
* use --head flag for cross-fork OperatorHub PR creation ([#55](https://github.com/openclaw-rocks/k8s-operator/issues/55)) ([568db8f](https://github.com/openclaw-rocks/k8s-operator/commit/568db8f170444ff015a7897c43161271c8903685))
...
* use RELEASE_PLEASE_TOKEN for OperatorHub submission ([#50](https://github.com/openclaw-rocks/k8s-operator/issues/50)) ([470df59](https://github.com/openclaw-rocks/k8s-operator/commit/470df59a66e30f0a46c11c2a2bda83d15019ddd2))
