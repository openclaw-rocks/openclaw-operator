...
func backupCronJobName(instance *openclawv1.OpenClawInstance) string {
...
func (r *OpenClawInstanceReconciler) reconcileBackupCronJob(ctx context.Context, instance *openclawv1.OpenClawInstance) error {
	...
	if instance.Spec.Storage.Persistence.Enabled != nil && !*instance.Spec.Storage.Persistence.Enabled {
		...
		meta.SetStatusCondition(&instance.Status.Conditions, metav1.Condition{
			Type:               openclawv1.ConditionTypeScheduledBackupReady,
...
func (r *OpenClawInstanceReconciler) cleanupBackupCronJob(ctx context.Context, instance *openclawv1.OpenClawInstance) error {
	...
	if err != nil {
		if apierrors.IsNotFound(err) {
			...
			meta.RemoveStatusCondition(&instance.Status.Conditions, openclawv1.ConditionTypeScheduledBackupReady)
			return nil
		}
